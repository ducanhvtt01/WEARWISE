...
@Composable
fun Step2Screen(viewModel: SurveyViewModel, onBack: () -> Unit, onNext: () -> Unit) {
    SurveyLayout(currentStep = 2,
        onBack = onBack,
        onNext = onNext) {
        ...
        verticalArrangement = Arrangement.spacedBy(12.dp)) {
            listOf("Hourglass", "Pear", "Rectangle", "Inverted Triangle", "Apple").
            forEach { shape ->
                SingleChoiceChip(text = shape,
        ...
        FlowRow(horizontalArrangement = Arrangement.spacedBy(12.dp),
            verticalArrangement = Arrangement.spacedBy(12.dp)) {
            listOf("Fair", "Medium", "Olive", "Tan", "Deep").
            forEach { tone ->
                SingleChoiceChip(text = tone,
