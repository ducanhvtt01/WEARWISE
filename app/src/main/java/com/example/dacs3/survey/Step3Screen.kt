...
fun Step3Screen(viewModel: SurveyViewModel) {
    Column(modifier = Modifier
        ...
        FlowRow(
            ...
            listOf(
                ...
                MultiChoiceChip(
                    ...
                    onClick = {
                        viewModel.favoriteStyles =
                            if (viewModel.favoriteStyles.contains(style)) viewModel.favoriteStyles - style else viewModel.favoriteStyles + style
                    })
            }
        }
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
            Column(modifier = Modifier.weight(1f)) {
                ...
                DropdownSizeSelector(
                    ...
                    onSelect = { viewModel.topSize = it })
            }
            Column(modifier = Modifier.weight(1f)) {
                Text("Bottom", fontSize = 12.sp, color = MaterialTheme.colorScheme.onSurfaceVariant)
                DropdownSizeSelector(
                    selected = viewModel.bottomSize,
                    options = listOf("S", "M", "L", "XL", "28", "30", "32", "34"),
                    onSelect = { viewModel.bottomSize = it })
            }
        }
        Spacer(modifier = Modifier.height(24.dp))
        ...
        Slider(
            ...
            onValueChange = { viewModel.shoeSize = it },
            valueRange = 35f..46f,
            steps = 10,
